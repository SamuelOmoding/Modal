...
import m10 from '../assets/m/m4.png'
...
const MARQUEE_ONLY = [
  ...
  { id: 12, src: m2,  label: 'Street Style',     category: 'Lifestyle'     },
  { id: 13, src: m3,  label: 'Campaign Shoot',   category: 'Commercial'    },
  { id: 14, src: m4,  label: 'Outdoor Session',  category: 'Editorial'     },
  { id: 15, src: m5,  label: 'Formal Look',      category: 'Corporate'     },
  { id: 16, src: m6,  label: 'Casual Shoot',     category: 'Lifestyle'     },
  { id: 17, src: m7,  label: 'Runway Ready',     category: 'Fashion'       },
  { id: 18, src: m11,  label: 'Studio Session',   category: 'Studio'        },
  { id: 19, src: m24,  label: 'Fitness Focus',    category: 'Fitness'       },
  { id: 20, src: m10, label: 'Portrait Play',    category: 'Portrait'      },
  { id: 21, src: m9, label: 'Brand Identity',   category: 'Brand'         },
  { id: 22, src: m26, label: 'Travel Diaries',   category: 'Tourism'       },
  { id: 23, src: m13, label: 'Monochrome Magic', category: 'Editorial'     },
  { id: 24, src: m14, label: 'Color Splash',     category: 'Fashion'       },
  { id: 25, src: m8, label: 'Urban Vibes',      category: 'Street'        },
  { id: 26, src: m16, label: 'Nature Shots',     category: 'Nature'        },
  { id: 27, src: m19, label: 'Event Highlights', category: 'Event'         },
  { id: 28, src: m18, label: 'Foodie Frames',    category: 'Food'          },
  { id: 29, src: m15, label: 'Architectural',     category: 'Architecture'   },
  { id: 30, src: m20, label: 'Nightscapes',      category: 'Night'         },
  { id: 31, src: m21, label: 'Candid Moments',    category: 'Candid'        },
  { id: 32, src: m22, label: 'Fashion Editorial', category: 'Fashion'       },
  { id: 33, src: m23, label: 'Travel Portraits',  category: 'Travel'        },
  { id: 34, src: m17, label: 'Studio Portraits',  category: 'Studio'        },
  { id: 36, src: m12, label: 'Commercial Work',    category: 'Commercial'    },
]
    ...
    <>
      <style>{`
        ...
        @media (max-width: 420px) {
          ...
          .portfolio-item-featured { grid-column: span 1; max-height: 400px; }
